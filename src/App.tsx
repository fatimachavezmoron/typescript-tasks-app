...
interface Task {
  ...
  const App: React.FC = () => {
    ...
    const handleSubmit = (e: React.FormEvent) => {
      e.preventDefault();
      const titleInput = e.currentTarget['title'] as HTMLInputElement;
      const descriptionInput = e.currentTarget['description'] as HTMLTextAreaElement;
      ...
      <div className="bg-slate-800 text-white">
       <div className="flex justify-center items-center h-screen gap-x-2">
        <form onSubmit={handleSubmit} className="bg-slate-600 p-10 rounded-md max-w-md">
            ...
            <label for="tdescription" className="block">Description</label>
